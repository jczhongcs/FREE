...
## Create File
hdf5_path = "E:\\SXR2\\datasetdotosmhdqbxf.hdf5"
if not os.path.exists(hdf5_path):
  hf = h5py.File(hdf5_path, mode='a') 
  hf.create_dataset("train_data", (0,300, 9), maxshape=(None, 300, 9), dtype=np.float, chunks=True)
  hf.create_dataset("val_data", (0,300, 9), maxshape=(None, 300, 9), dtype=np.float, chunks=True)
  hf.create_dataset("test_data", (0,300, 9), maxshape=(None, 300, 9), dtype=np.float, chunks=True)
...
## Merge Data
data_dir = "D:\\SXR\\envcnn-master\\dataset1dotosmhdqbxf.hdf5"    #把data_dir的数据并入到hdf5_path
#data_dir = "dataset10dotosmhdqbxf.hdf5" 
