...
def populate_matrix(feature, matrix, mono_mass):
  pos = feature.bin_index           #pos表示这一组特征值在哪一个bin里，即位于6*300矩阵的哪一列
  if pos > -1 and pos < 300:
    ...
    matrix[pos][5]=feature.inte_dot_proc
    matrix[pos][6]=feature.inte_os_dis
    #matrix[pos][6]=feature.inte_os_dis
    matrix[pos][7]=feature.inte_mhd_dis
    matrix[pos][8]=feature.inte_qbxf_dis
    #matrix[pos][6]=feature.inte_nom_os_dis
